...
- **Manifest** — every trip's own packing slip, ticked off as you pack (items
  take a rubber PACKED stamp). Packing lists hold what you always pack and
  copy onto any trip, and anything you add mid-trip can be promoted back to
  a packing list so the lists sharpen with every holiday
